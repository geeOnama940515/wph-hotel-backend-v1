        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContactInfo_Address = table.Column<string>(type: "text", nullable: false),
                    EmailAddress = table.Column<string>(type: "text", nullable: false),
                    TotalAmount = table.Column<decimal>(type: "numeric", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    SpecialRequests = table.Column<string>(type: "text", nullable: false),
                    BookingToken = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<string>(type: "text", nullable: false),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GalleryImage", x => new { x.RoomId, x.FileName });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Bookings",
                columns: new[] { "Id", "BookingToken", "CheckIn", "CheckOut", "CreatedAt", "CreatedBy", "EmailAddress", "Guests", "RoomId", "SpecialRequests", "Status", "TotalAmount", "UpdatedAt", "UpdatedBy", "UserId", "ContactInfo_Address", "ContactInfo_Phone" },
                values: new object[] { new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), new DateTime(2025, 7, 1, 14, 0, 0, 0, DateTimeKind.Utc), new DateTime(2025, 7, 4, 11, 0, 0, 0, DateTimeKind.Utc), new DateTimeOffset(new DateTime(2025, 6, 1, 12, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "Seeder", "guest@example.com", 2, new Guid("11111111-1111-1111-1111-111111111111"), "Vegetarian meals only", 1, 7500m, null, null, new Guid("12345678-90ab-cdef-1234-567890abcdef"), "123 Beach Road, Pagudpud", "09171234567" });
